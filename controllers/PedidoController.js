...
exports.criarPedido = async (req, res) => {
  try {
    ...
    // Nota: Em um ambiente de produção, considere validar os dados do pedido antes de salvar.
  } catch (error) {
    res.status(400).json({
      success: false,
...
exports.listarPedidos = async (req, res) => {
  try {
    ...
    // Nota: Em um ambiente de produção, considere implementar paginação para grandes volumes de dados.
